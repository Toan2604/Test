...
namespace DMS.Enums
{
    public class KpiCriteriaItemEnum
    {
        ...
        public static GenericEnum DIRECT_REVENUE = new GenericEnum { Id = 6, Code = "DirectRevenue", Name = "Doanh thu ĐTT" };
        //public static GenericEnum DIRECT_AMOUNT = new GenericEnum { Id = 7, Code = "DirectAmount", Name = "Số đơn hàng trực tiếp" };
        public static GenericEnum DIRECT_STORE = new GenericEnum { Id = 8, Code = "DirectStore", Name = "Số đại lý hiện diện ĐTT" };
