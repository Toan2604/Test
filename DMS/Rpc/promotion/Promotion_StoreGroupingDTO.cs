...
{
    public class Promotion_StoreGroupingDTO : DataDTO
    {
        ...
        public Promotion_StoreGroupingDTO() { }
        public Promotion_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class Promotion_StoreGroupingFilterDTO : FilterDTO
    {
