...
{
    public class Promotion_ProductDTO : DataDTO
    {
        ...
        public Promotion_ProductDTO() { }
        public Promotion_ProductDTO(Product Product)
        {
    ...
    public class Promotion_ProductFilterDTO : FilterDTO
    {
