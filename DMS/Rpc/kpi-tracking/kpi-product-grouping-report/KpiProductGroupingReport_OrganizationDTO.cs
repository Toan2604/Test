...
{
    public class KpiProductGroupingReport_OrganizationDTO : DataDTO
    {
        ...
        public KpiProductGroupingReport_OrganizationDTO() { }
        public KpiProductGroupingReport_OrganizationDTO(Organization Organization)
        {
    ...
    public class KpiProductGroupingReport_OrganizationFilterDTO : FilterDTO
    {
