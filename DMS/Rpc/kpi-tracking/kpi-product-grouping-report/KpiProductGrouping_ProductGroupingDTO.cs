...
{
    public class KpiProductGroupingReport_ProductGroupingDTO : DataDTO
    {
        ...
        public KpiProductGroupingReport_ProductGroupingDTO() { }
        public KpiProductGroupingReport_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class KpiProductGroupingReport_ProductGroupingFilterDTO : FilterDTO
    {
