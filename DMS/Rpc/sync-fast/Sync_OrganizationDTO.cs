...
{
    public class Sync_OrganizationDTO : DataDTO
    {
        ...
        public Sync_OrganizationDTO() { }
        public Sync_OrganizationDTO(Organization Organization)
        {
    ...
    public class Sync_OrganizationFilterDTO : FilterDTO
    {
