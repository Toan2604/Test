...
{
    public class Sync_DirectSalesOrderContentDTO : DataDTO
    {
        ...
        public Sync_DirectSalesOrderContentDTO() { }
        public Sync_DirectSalesOrderContentDTO(DirectSalesOrderContent DirectSalesOrderContent)
        {
