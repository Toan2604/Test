...
{
    public class MonitorStoreImage_OrganizationDTO : DataDTO
    {
        ...
        public MonitorStoreImage_OrganizationDTO() { }
        public MonitorStoreImage_OrganizationDTO(Organization Organization)
        {
