...
{
    public class MonitorSalesman_DistrictDTO : DataDTO
    {
        ...
        public MonitorSalesman_DistrictDTO() { }
        public MonitorSalesman_DistrictDTO(District District)
        {
    ...
    public class MonitorSalesman_DistrictFilterDTO : FilterDTO
    {
