...
{
    public class MonitorSalesman_StoreDTO : DataDTO
    {
        ...
        public MonitorSalesman_StoreDTO() { }
        public MonitorSalesman_StoreDTO(Store Store)
        {
    ...
    public class MonitorSalesman_StoreFilterDTO : FilterDTO
    {
