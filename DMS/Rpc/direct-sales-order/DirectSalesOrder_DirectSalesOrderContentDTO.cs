...
namespace DMS.Rpc.direct_sales_order
{
    public class DirectSalesOrder_DirectSalesOrderContentDTO : DataDTO
    {
        ...
        public DirectSalesOrder_DirectSalesOrderContentDTO(DirectSalesOrderContent DirectSalesOrderContent)
        {
            ...
            this.InventoryCheckStateId = DirectSalesOrderContent.InventoryCheckStateId;
            ...
            this.InventoryCheckState = DirectSalesOrderContent.InventoryCheckState == null ? null : new DirectSalesOrder_InventoryCheckStateDTO(DirectSalesOrderContent.InventoryCheckState);
