...
{
    public class DirectSalesOrder_BrandDTO : DataDTO
    {
        ...
        public DirectSalesOrder_BrandDTO() { }
        public DirectSalesOrder_BrandDTO(Brand Brand)
        {
    ...
    public class DirectSalesOrder_BrandFilterDTO : FilterDTO
    {
