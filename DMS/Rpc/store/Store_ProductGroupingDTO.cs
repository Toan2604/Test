...
{
    public class Store_ProductGroupingDTO : DataDTO
    {
        ...
        public Store_ProductGroupingDTO() { }
        public Store_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class Store_ProductGroupingFilterDTO : FilterDTO
    {
