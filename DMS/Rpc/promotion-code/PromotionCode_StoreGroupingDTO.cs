...
{
    public class PromotionCode_StoreGroupingDTO : DataDTO
    {
        ...
        public PromotionCode_StoreGroupingDTO() { }
        public PromotionCode_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class PromotionCode_StoreGroupingFilterDTO : FilterDTO
    {
