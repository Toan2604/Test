...
{
    public class ReportStatisticProblem_OrganizationDTO : DataDTO
    {
        ...
        public ReportStatisticProblem_OrganizationDTO() { }
        public ReportStatisticProblem_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportStatisticProblem_OrganizationFilterDTO : FilterDTO
    {
