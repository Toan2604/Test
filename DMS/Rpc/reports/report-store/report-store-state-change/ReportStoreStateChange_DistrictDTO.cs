...
{
    public class ReportStoreStateChange_DistrictDTO : DataDTO
    {
        ...
        public ReportStoreStateChange_DistrictDTO() { }
        public ReportStoreStateChange_DistrictDTO(District District)
        {
    ...
    public class ReportStoreStateChange_DistrictFilterDTO : FilterDTO
    {
