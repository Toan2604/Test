...
{
    public class ReportStoreGeneral_AppUserDTO : DataDTO
    {
        ...
        public ReportStoreGeneral_AppUserDTO() { }
        public ReportStoreGeneral_AppUserDTO(AppUser AppUser)
        {
            this.Id = AppUser.Id;
    ...
    public class ReportStoreGeneral_AppUserFilterDTO : FilterDTO
    {
