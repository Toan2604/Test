...
{
    public class ReportStoreGeneral_OrganizationDTO : DataDTO
    {
        ...
        public ReportStoreGeneral_OrganizationDTO() { }
        public ReportStoreGeneral_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportStoreGeneral_OrganizationFilterDTO : FilterDTO
    {
