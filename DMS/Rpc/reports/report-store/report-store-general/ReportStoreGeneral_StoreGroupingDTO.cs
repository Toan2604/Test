...
{
    public class ReportStoreGeneral_StoreGroupingDTO : DataDTO
    {
        ...
        public ReportStoreGeneral_StoreGroupingDTO() { }
        public ReportStoreGeneral_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class ReportStoreGeneral_StoreGroupingFilterDTO : FilterDTO
    {
