...
{
    public class ReportStoreGeneral_DistrictDTO : DataDTO
    {
        ...
        public ReportStoreGeneral_DistrictDTO() { }
        public ReportStoreGeneral_DistrictDTO(District District)
        {
    ...
    public class ReportStoreGeneral_DistrictFilterDTO : FilterDTO
    {
