...
{
    public class ReportSalesOrderByItem_OrganizationDTO : DataDTO
    {
        ...
        public ReportSalesOrderByItem_OrganizationDTO() { }
        public ReportSalesOrderByItem_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportSalesOrderByEmployeeAndItem_OrganizationFilterDTO : FilterDTO
    {
