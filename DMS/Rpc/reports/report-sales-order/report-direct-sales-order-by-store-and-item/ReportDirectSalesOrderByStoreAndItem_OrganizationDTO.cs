...
{
    public class ReportDirectSalesOrderByStoreAndItem_OrganizationDTO : DataDTO
    {
        ...
        public ReportDirectSalesOrderByStoreAndItem_OrganizationDTO() { }
        public ReportDirectSalesOrderByStoreAndItem_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportDirectSalesOrderByStoreAndItem_OrganizationFilterDTO : FilterDTO
    {
