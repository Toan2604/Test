...
{
    public class ReportDirectSalesOrderGeneral_OrganizationDTO : DataDTO
    {
        ...
        public ReportDirectSalesOrderGeneral_OrganizationDTO() { }
        public ReportDirectSalesOrderGeneral_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportDirectSalesOrderGeneral_OrganizationFilterDTO : FilterDTO
    {
