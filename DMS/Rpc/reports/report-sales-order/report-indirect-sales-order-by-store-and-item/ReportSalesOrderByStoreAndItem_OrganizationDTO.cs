...
{
    public class ReportSalesOrderByStoreAndItem_OrganizationDTO : DataDTO
    {
        ...
        public ReportSalesOrderByStoreAndItem_OrganizationDTO() { }
        public ReportSalesOrderByStoreAndItem_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportSalesOrderByStoreAndItem_OrganizationFilterDTO : FilterDTO
    {
