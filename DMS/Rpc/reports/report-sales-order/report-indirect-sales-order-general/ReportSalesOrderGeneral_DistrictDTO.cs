...
{
    public class ReportSalesOrderGeneral_DistrictDTO : DataDTO
    {
        ...
        public ReportSalesOrderGeneral_DistrictDTO() { }
        public ReportSalesOrderGeneral_DistrictDTO(District District)
        {
    ...
    public class ReportSalesOrderGeneral_DistrictFilterDTO : FilterDTO
    {
