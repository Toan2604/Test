...
{
    public class ReportSalesOrderGeneral_OrganizationDTO : DataDTO
    {
        ...
        public ReportSalesOrderGeneral_OrganizationDTO() { }
        public ReportSalesOrderGeneral_OrganizationDTO(Organization Organization)
        {
    ...
    public class ReportSalesOrderGeneral_OrganizationFilterDTO : FilterDTO
    {
