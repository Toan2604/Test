...
{
    public class LuckyNumber_OrganizationDTO : DataDTO
    {
        ...
        public LuckyNumber_OrganizationDTO() { }
        public LuckyNumber_OrganizationDTO(Organization Organization)
        {
    ...
    public class LuckyNumber_OrganizationFilterDTO : FilterDTO
    {
