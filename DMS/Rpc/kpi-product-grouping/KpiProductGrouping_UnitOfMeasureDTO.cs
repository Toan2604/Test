...
{
    public class KpiProductGrouping_UnitOfMeasureDTO : DataDTO, IEquatable<KpiProductGrouping_UnitOfMeasureDTO>
    {
        ...
        public KpiProductGrouping_UnitOfMeasureDTO() { }
        public KpiProductGrouping_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
        ...
        public KpiProductGrouping_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
        ...
        public bool Equals(KpiProductGrouping_UnitOfMeasureDTO other)
        {
    ...
    public class KpiProductGrouping_UnitOfMeasureFilterDTO : FilterDTO
    {
