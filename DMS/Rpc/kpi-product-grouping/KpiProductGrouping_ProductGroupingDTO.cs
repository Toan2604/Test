...
{
    public class KpiProductGrouping_ProductGroupingDTO : DataDTO
    {
        ...
        public KpiProductGrouping_ProductGroupingDTO() { }
        public KpiProductGrouping_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class KpiProductGrouping_ProductGroupingFilterDTO : FilterDTO
    {
