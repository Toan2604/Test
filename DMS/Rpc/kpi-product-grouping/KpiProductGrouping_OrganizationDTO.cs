...
{
    public class KpiProductGrouping_OrganizationDTO : DataDTO
    {
        ...
        public KpiProductGrouping_OrganizationDTO() { }
        public KpiProductGrouping_OrganizationDTO(Organization Organization)
        {
    ...
    public class KpiProductGrouping_OrganizationFilterDTO : FilterDTO
    {
