...
{
    public class PriceList_StoreTypeDTO : DataDTO
    {
        ...
        public PriceList_StoreTypeDTO() { }
        public PriceList_StoreTypeDTO(StoreType StoreType)
        {
    ...
    public class PriceList_StoreTypeFilterDTO : FilterDTO
    {
