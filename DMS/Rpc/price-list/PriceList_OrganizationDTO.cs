...
{
    public class PriceList_OrganizationDTO : DataDTO
    {
        ...
        public PriceList_OrganizationDTO() { }
        public PriceList_OrganizationDTO(Organization Organization)
        {
    ...
    public class PriceList_OrganizationFilterDTO : FilterDTO
    {
