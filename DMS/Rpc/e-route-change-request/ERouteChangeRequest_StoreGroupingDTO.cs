...
{
    public class ERouteChangeRequest_StoreGroupingDTO : DataDTO
    {
        ...
        public ERouteChangeRequest_StoreGroupingDTO() { }
        public ERouteChangeRequest_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class ERouteChangeRequest_StoreGroupingFilterDTO : FilterDTO
    {
