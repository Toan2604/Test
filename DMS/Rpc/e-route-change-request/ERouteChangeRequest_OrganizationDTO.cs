...
{
    public class ERouteChangeRequest_OrganizationDTO : DataDTO
    {
        ...
        public ERouteChangeRequest_OrganizationDTO() { }
        public ERouteChangeRequest_OrganizationDTO(Organization Organization)
        {
    ...
    public class ERouteChangeRequest_OrganizationFilterDTO : FilterDTO
    {
