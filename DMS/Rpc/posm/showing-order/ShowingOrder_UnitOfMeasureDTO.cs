...
{
    public class ShowingOrder_UnitOfMeasureDTO : DataDTO
    {
        ...
        public ShowingOrder_UnitOfMeasureDTO() { }
        public ShowingOrder_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class ShowingOrder_UnitOfMeasureFilterDTO : FilterDTO
    {
