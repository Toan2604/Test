...
{
    public class ShowingOrder_StoreGroupingDTO : DataDTO
    {
        ...
        public ShowingOrder_StoreGroupingDTO() { }
        public ShowingOrder_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class ShowingOrder_StoreGroupingFilterDTO : FilterDTO
    {
