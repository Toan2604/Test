...
{
    public class ShowingOrder_OrganizationDTO : DataDTO
    {
        ...
        public ShowingOrder_OrganizationDTO() { }
        public ShowingOrder_OrganizationDTO(Organization Organization)
        {
    ...
    public class ShowingOrder_OrganizationFilterDTO : FilterDTO
    {
