...
{
    public class ShowingOrder_AppUserDTO : DataDTO
    {
        ...
        public ShowingOrder_AppUserDTO() { }
        public ShowingOrder_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ShowingOrder_AppUserFilterDTO : FilterDTO
    {
