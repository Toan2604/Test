...
{
    public class ShowingOrderWithDraw_AppUserDTO : DataDTO
    {
        ...
        public ShowingOrderWithDraw_AppUserDTO() { }
        public ShowingOrderWithDraw_AppUserDTO(AppUser AppUser)
        {
    ...
    public class ShowingOrderWithDraw_AppUserFilterDTO : FilterDTO
    {
