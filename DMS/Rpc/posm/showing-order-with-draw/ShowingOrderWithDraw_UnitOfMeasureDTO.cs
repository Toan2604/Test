...
{
    public class ShowingOrderWithDraw_UnitOfMeasureDTO : DataDTO
    {
        ...
        public ShowingOrderWithDraw_UnitOfMeasureDTO() { }
        public ShowingOrderWithDraw_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
    ...
    public class ShowingOrderWithDraw_UnitOfMeasureFilterDTO : FilterDTO
    {
