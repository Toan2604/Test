...
{
    public class ShowingOrderWithDraw_OrganizationDTO : DataDTO
    {
        ...
        public ShowingOrderWithDraw_OrganizationDTO() { }
        public ShowingOrderWithDraw_OrganizationDTO(Organization Organization)
        {
    ...
    public class ShowingOrderWithDraw_OrganizationFilterDTO : FilterDTO
    {
