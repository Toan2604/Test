...
{
    public class ShowingOrderWithDraw_StoreDTO : DataDTO
    {
        ...
        public ShowingOrderWithDraw_StoreDTO() { }
        public ShowingOrderWithDraw_StoreDTO(Store Store)
        {
    ...
    public class ShowingOrderWithDraw_StoreFilterDTO : FilterDTO
    {
