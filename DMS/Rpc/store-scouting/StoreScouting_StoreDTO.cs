...
{
    public class StoreScouting_StoreDTO : DataDTO
    {
        ...
        public StoreScouting_StoreDTO() { }
        public StoreScouting_StoreDTO(Store Store)
        {
    ...
    public class StoreScouting_StoreFilterDTO : FilterDTO
    {
