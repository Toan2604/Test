...
{
    public class StoreScouting_DistrictDTO : DataDTO
    {
        ...
        public StoreScouting_DistrictDTO() { }
        public StoreScouting_DistrictDTO(District District)
        {
    ...
    public class StoreScouting_DistrictFilterDTO : FilterDTO
    {
