...
namespace DMS.Rpc.lucky_draw
{
    public class LuckyDraw_LuckyDrawDTO : DataDTO
    {
        ...
        public LuckyDraw_LuckyDrawDTO(LuckyDraw LuckyDraw)
        {
            ...
            this.StartAt = LuckyDraw.StartAt == default(DateTime) ? null : (DateTime?) LuckyDraw.StartAt;
            this.EndAt = LuckyDraw.EndAt == default(DateTime) ? null : (DateTime?)LuckyDraw.EndAt;
            ...
            this.Organization = LuckyDraw.Organization == null ? null : new LuckyDraw_OrganizationDTO(LuckyDraw.Organization);
