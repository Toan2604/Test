...
namespace DMS.Rpc.lucky_draw
{
    ...
    {
        [Route(LuckyDrawRoute.SingleListImage), HttpPost]
        public async Task<List<LuckyDraw_ImageDTO>> SingleListImage([FromBody] LuckyDraw_ImageFilterDTO LuckyDraw_ImageFilterDTO)
        {
            ...
            ImageFilter.Id = LuckyDraw_ImageFilterDTO.Id;
            ImageFilter.Name = LuckyDraw_ImageFilterDTO.Name;
            ImageFilter.Url = LuckyDraw_ImageFilterDTO.Url;
            ImageFilter.ThumbnailUrl = LuckyDraw_ImageFilterDTO.ThumbnailUrl;
            List<Image> Images = await ImageService.List(ImageFilter);
            List<LuckyDraw_ImageDTO> LuckyDraw_ImageDTOs = Images
                .Select(x => new LuckyDraw_ImageDTO(x)).ToList();
            return LuckyDraw_ImageDTOs;
        }
        [Route(LuckyDrawRoute.SingleListLuckyDrawType), HttpPost]
        public async Task<List<LuckyDraw_LuckyDrawTypeDTO>> SingleListLuckyDrawType([FromBody] LuckyDraw_LuckyDrawTypeFilterDTO LuckyDraw_LuckyDrawTypeFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(LuckyDrawRoute.SingleListOrganization), HttpPost]
        public async Task<List<LuckyDraw_OrganizationDTO>> SingleListOrganization([FromBody] LuckyDraw_OrganizationFilterDTO LuckyDraw_OrganizationFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            ...
            OrganizationFilter.StatusId = LuckyDraw_OrganizationFilterDTO.StatusId;
        ...
        [Route(LuckyDrawRoute.SingleListStatus), HttpPost]
        public async Task<List<LuckyDraw_StatusDTO>> SingleListStatus([FromBody] LuckyDraw_StatusFilterDTO LuckyDraw_StatusFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(LuckyDrawRoute.SingleListStoreGrouping), HttpPost]
        public async Task<List<LuckyDraw_StoreGroupingDTO>> SingleListStoreGrouping([FromBody] LuckyDraw_StoreGroupingFilterDTO LuckyDraw_StoreGroupingFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            ...
            StoreGroupingFilter.StatusId = LuckyDraw_StoreGroupingFilterDTO.StatusId;
            StoreGroupingFilter.StatusId = new IdFilter{ Equal = 1 };
        ...
        [Route(LuckyDrawRoute.SingleListStore), HttpPost]
        public async Task<List<LuckyDraw_StoreDTO>> SingleListStore([FromBody] LuckyDraw_StoreFilterDTO LuckyDraw_StoreFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            ...
            StoreFilter.StatusId = LuckyDraw_StoreFilterDTO.StatusId;
        ...
        [Route(LuckyDrawRoute.SingleListStoreType), HttpPost]
        public async Task<List<LuckyDraw_StoreTypeDTO>> SingleListStoreType([FromBody] LuckyDraw_StoreTypeFilterDTO LuckyDraw_StoreTypeFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
            ...
            StoreTypeFilter.StatusId = LuckyDraw_StoreTypeFilterDTO.StatusId;
            StoreTypeFilter.StatusId = new IdFilter{ Equal = 1 };
        ...
        [Route(LuckyDrawRoute.SingleListLuckyDrawStructure), HttpPost]
        public async Task<List<LuckyDraw_LuckyDrawStructureDTO>> SingleListLuckyDrawStructure([FromBody] LuckyDraw_LuckyDrawStructureFilterDTO LuckyDraw_LuckyDrawStructureFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(LuckyDrawRoute.SingleListLuckyDrawWinner), HttpPost]
        public async Task<List<LuckyDraw_LuckyDrawWinnerDTO>> SingleListLuckyDrawWinner([FromBody] LuckyDraw_LuckyDrawWinnerFilterDTO LuckyDraw_LuckyDrawWinnerFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(LuckyDrawRoute.SingleListAppUser), HttpPost]
        public async Task<List<LuckyDraw_AppUserDTO>> SingleListAppUser([FromBody] LuckyDraw_AppUserFilterDTO LuckyDraw_AppUserFilterDTO)
        {
            if (!ModelState.IsValid)
                throw new BindException(ModelState);
        ...
        [Route(LuckyDrawRoute.SingleListProvince), HttpPost]
        public async Task<List<LuckyDraw_ProvinceDTO>> SingleListProvince([FromBody] LuckyDraw_ProvinceFilterDTO LuckyDraw_ProvinceFilterDTO)
        {
            ...
            ProvinceFilter.Id = LuckyDraw_ProvinceFilterDTO.Id;
            ProvinceFilter.Name = LuckyDraw_ProvinceFilterDTO.Name;
            ProvinceFilter.StatusId = new IdFilter { Equal = StatusEnum.ACTIVE.Id };

            List<Province> Provinces = await ProvinceService.List(ProvinceFilter);
            List<LuckyDraw_ProvinceDTO> Store_ProvinceDTOs = Provinces
                .Select(x => new LuckyDraw_ProvinceDTO(x)).ToList();
