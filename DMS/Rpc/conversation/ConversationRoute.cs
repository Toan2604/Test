...
namespace DMS.Rpc.conversation
{
    public class ConversationRoute : Root
    {
        ...
        public static Dictionary<string, IEnumerable<string>> Action = new Dictionary<string, IEnumerable<string>>
        {
            { "Tìm kiếm", new List<string> {
                    ...
                    Get,  GetGlobalUser, UploadFile, MultiUploadFile, UploadAvatar,
                }
            },
            { "Thêm", new List<string> {
                    Parent,
                    Master, Preview, Count, List, Get,
                    Detail, Create, UploadFile, MultiUploadFile, UploadAvatar,
            ...
            { "Sửa", new List<string> {
                    Parent,
                    Master, Preview, Count, List, Get,
                    Detail, Update, UploadFile, MultiUploadFile, UploadAvatar,
                }.Concat(SingleList).Concat(CountList)
            },
            ...
            { "Xoá", new List<string> {
                    Parent,
                    Master, Preview, Count, List, Get,
                    Delete, UploadFile, MultiUploadFile, UploadAvatar,
                }.Concat(SingleList)
            },
        };
    }
