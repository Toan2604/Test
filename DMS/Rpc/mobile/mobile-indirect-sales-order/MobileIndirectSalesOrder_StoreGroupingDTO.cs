...
{
    public class MobileIndirectSalesOrder_StoreGroupingDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_StoreGroupingDTO() { }
        public MobileIndirectSalesOrder_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class MobileIndirectSalesOrder_StoreGroupingFilterDTO : FilterDTO
    {
