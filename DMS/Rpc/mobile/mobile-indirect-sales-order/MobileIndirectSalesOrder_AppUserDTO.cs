...
{
    public class MobileIndirectSalesOrder_AppUserDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_AppUserDTO() { }
        public MobileIndirectSalesOrder_AppUserDTO(AppUser AppUser)
        {
    ...
    public class MobileIndirectSalesOrder_AppUserFilterDTO : FilterDTO
    {
