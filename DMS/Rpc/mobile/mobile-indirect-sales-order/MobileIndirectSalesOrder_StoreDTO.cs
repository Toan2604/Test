...
{
    public class MobileIndirectSalesOrder_StoreDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_DistrictDTO District { get; set; }
        public MobileIndirectSalesOrder_OrganizationDTO Organization { get; set; }
        public MobileIndirectSalesOrder_StoreDTO ParentStore { get; set; }
        public MobileIndirectSalesOrder_ProvinceDTO Province { get; set; }
        public MobileIndirectSalesOrder_StoreTypeDTO StoreType { get; set; }
        public MobileIndirectSalesOrder_WardDTO Ward { get; set; }
        public MobileIndirectSalesOrder_AppUserDTO Creator { get; set; }
        public MobileIndirectSalesOrder_StoreDTO() { }
        public MobileIndirectSalesOrder_StoreDTO(Store Store)
        {
            this.Id = Store.Id;
            ...
            this.Creator = Store.Creator == null ? null : new MobileIndirectSalesOrder_AppUserDTO(Store.Creator);
            this.District = Store.District == null ? null : new MobileIndirectSalesOrder_DistrictDTO(Store.District);
            this.Organization = Store.Organization == null ? null : new MobileIndirectSalesOrder_OrganizationDTO(Store.Organization);
            this.ParentStore = Store.ParentStore == null ? null : new MobileIndirectSalesOrder_StoreDTO(Store.ParentStore);
            this.Province = Store.Province == null ? null : new MobileIndirectSalesOrder_ProvinceDTO(Store.Province);
            this.StoreType = Store.StoreType == null ? null : new MobileIndirectSalesOrder_StoreTypeDTO(Store.StoreType);
            this.Ward = Store.Ward == null ? null : new MobileIndirectSalesOrder_WardDTO(Store.Ward);
            this.Errors = Store.Errors;
            this.Warnings = Store.Warnings;
        }
    }

    public class MobileIndirectSalesOrder_StoreFilterDTO : FilterDTO
    {
