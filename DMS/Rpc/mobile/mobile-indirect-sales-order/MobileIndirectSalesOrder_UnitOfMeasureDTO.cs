...
{
    public class MobileIndirectSalesOrder_UnitOfMeasureDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_UnitOfMeasureDTO() { }
        public MobileIndirectSalesOrder_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
        ...
        public MobileIndirectSalesOrder_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
    ...
    public class MobileIndirectSalesOrder_UnitOfMeasureFilterDTO : FilterDTO
    {
