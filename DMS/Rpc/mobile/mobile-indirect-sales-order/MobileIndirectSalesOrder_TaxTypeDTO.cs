...
{
    public class MobileIndirectSalesOrder_TaxTypeDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_TaxTypeDTO() { }
        public MobileIndirectSalesOrder_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class MobileIndirectSalesOrder_TaxTypeFilterDTO : FilterDTO
    {
