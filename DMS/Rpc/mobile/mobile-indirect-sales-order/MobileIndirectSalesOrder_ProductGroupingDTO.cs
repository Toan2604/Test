...
{
    public class MobileIndirectSalesOrder_ProductGroupingDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_ProductGroupingDTO() { }
        public MobileIndirectSalesOrder_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class MobileIndirectSalesOrder_ProductGroupingFilterDTO : FilterDTO
    {
