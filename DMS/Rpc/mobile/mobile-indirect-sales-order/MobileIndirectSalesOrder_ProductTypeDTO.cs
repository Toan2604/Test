...
{
    public class MobileIndirectSalesOrder_ProductTypeDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_ProductTypeDTO() { }
        public MobileIndirectSalesOrder_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class MobileIndirectSalesOrder_ProductTypeFilterDTO : FilterDTO
    {
