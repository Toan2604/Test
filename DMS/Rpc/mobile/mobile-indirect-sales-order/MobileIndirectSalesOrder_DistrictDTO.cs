...
{
    public class MobileIndirectSalesOrder_DistrictDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_DistrictDTO() { }
        public MobileIndirectSalesOrder_DistrictDTO(District District)
        {
    ...
    public class MobileIndirectSalesOrder_DistrictFilterDTO : FilterDTO
    {
