...
{
    public class MobileIndirectSalesOrder_OrganizationDTO : DataDTO
    {
        ...
        public MobileIndirectSalesOrder_OrganizationDTO() { }
        public MobileIndirectSalesOrder_OrganizationDTO(Organization Organization)
        {
    ...
    public class MobileIndirectSalesOrder_OrganizationFilterDTO : FilterDTO
    {
