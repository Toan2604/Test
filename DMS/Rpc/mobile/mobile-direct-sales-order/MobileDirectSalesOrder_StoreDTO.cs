...
{
    public class MobileDirectSalesOrder_StoreDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_DistrictDTO District { get; set; }
        public MobileDirectSalesOrder_OrganizationDTO Organization { get; set; }
        public MobileDirectSalesOrder_StoreDTO ParentStore { get; set; }
        public MobileDirectSalesOrder_ProvinceDTO Province { get; set; }
        public MobileDirectSalesOrder_StoreTypeDTO StoreType { get; set; }
        public MobileDirectSalesOrder_WardDTO Ward { get; set; }
        public MobileDirectSalesOrder_AppUserDTO Creator { get; set; }
        public MobileDirectSalesOrder_StoreDTO() { }
        public MobileDirectSalesOrder_StoreDTO(Store Store)
        {
            this.Id = Store.Id;
            ...
            this.Creator = Store.Creator == null ? null : new MobileDirectSalesOrder_AppUserDTO(Store.Creator);
            this.District = Store.District == null ? null : new MobileDirectSalesOrder_DistrictDTO(Store.District);
            this.Organization = Store.Organization == null ? null : new MobileDirectSalesOrder_OrganizationDTO(Store.Organization);
            this.ParentStore = Store.ParentStore == null ? null : new MobileDirectSalesOrder_StoreDTO(Store.ParentStore);
            this.Province = Store.Province == null ? null : new MobileDirectSalesOrder_ProvinceDTO(Store.Province);
            this.StoreType = Store.StoreType == null ? null : new MobileDirectSalesOrder_StoreTypeDTO(Store.StoreType);
            this.Ward = Store.Ward == null ? null : new MobileDirectSalesOrder_WardDTO(Store.Ward);
            this.Errors = Store.Errors;
            this.Warnings = Store.Warnings;
        }
    }

    public class MobileDirectSalesOrder_StoreFilterDTO : FilterDTO
    {
