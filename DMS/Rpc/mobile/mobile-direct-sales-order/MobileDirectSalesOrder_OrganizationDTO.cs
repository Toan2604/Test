...
{
    public class MobileDirectSalesOrder_OrganizationDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_OrganizationDTO() { }
        public MobileDirectSalesOrder_OrganizationDTO(Organization Organization)
        {
    ...
    public class MobileDirectSalesOrder_OrganizationFilterDTO : FilterDTO
    {
