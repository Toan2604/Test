...
{
    public class MobileDirectSalesOrder_AppUserDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_AppUserDTO() { }
        public MobileDirectSalesOrder_AppUserDTO(AppUser AppUser)
        {
    ...
    public class MobileDirectSalesOrder_AppUserFilterDTO : FilterDTO
    {
