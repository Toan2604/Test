...
{
    public class MobileDirectSalesOrder_TaxTypeDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_TaxTypeDTO() { }
        public MobileDirectSalesOrder_TaxTypeDTO(TaxType TaxType)
        {
    ...
    public class MobileDirectSalesOrder_TaxTypeFilterDTO : FilterDTO
    {
