...
{
    public class MobileDirectSalesOrder_ProductTypeDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_ProductTypeDTO() { }
        public MobileDirectSalesOrder_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class MobileDirectSalesOrder_ProductTypeFilterDTO : FilterDTO
    {
