...
{
    public class MobileDirectSalesOrder_ProductGroupingDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_ProductGroupingDTO() { }
        public MobileDirectSalesOrder_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class MobileDirectSalesOrder_ProductGroupingFilterDTO : FilterDTO
    {
