...
{
    public class MobileDirectSalesOrder_DistrictDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_DistrictDTO() { }
        public MobileDirectSalesOrder_DistrictDTO(District District)
        {
    ...
    public class MobileDirectSalesOrder_DistrictFilterDTO : FilterDTO
    {
