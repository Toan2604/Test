...
{
    public class MobileDirectSalesOrder_UnitOfMeasureDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_UnitOfMeasureDTO() { }
        public MobileDirectSalesOrder_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
        ...
        public MobileDirectSalesOrder_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
    ...
    public class MobileDirectSalesOrder_UnitOfMeasureFilterDTO : FilterDTO
    {
