...
{
    public class MobileDirectSalesOrder_StoreGroupingDTO : DataDTO
    {
        ...
        public MobileDirectSalesOrder_StoreGroupingDTO() { }
        public MobileDirectSalesOrder_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class MobileDirectSalesOrder_StoreGroupingFilterDTO : FilterDTO
    {
