...
{
    public class GeneralMobile_UnitOfMeasureDTO : DataDTO
    {
        ...
        public GeneralMobile_UnitOfMeasureDTO() { }
        public GeneralMobile_UnitOfMeasureDTO(UnitOfMeasure UnitOfMeasure)
        {
        ...
        public GeneralMobile_UnitOfMeasureDTO(UnitOfMeasureGroupingContent UnitOfMeasureGroupingContent)
        {
    ...
    public class GeneralMobile_UnitOfMeasureFilterDTO : FilterDTO
    {
