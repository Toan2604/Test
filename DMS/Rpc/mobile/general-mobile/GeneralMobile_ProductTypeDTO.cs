...
{
    public class GeneralMobile_ProductTypeDTO : DataDTO
    {
        ...
        public GeneralMobile_ProductTypeDTO() { }
        public GeneralMobile_ProductTypeDTO(ProductType ProductType)
        {
    ...
    public class GeneralMobile_ProductTypeFilterDTO : FilterDTO
    {
