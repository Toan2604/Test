...
{
    public class GeneralMobile_AppUserDTO : DataDTO
    {
        ...
        public GeneralMobile_AppUserDTO() { }
        public GeneralMobile_AppUserDTO(AppUser AppUser)
        {
    ...
    public class GeneralMobile_AppUserFilterDTO : FilterDTO
    {
