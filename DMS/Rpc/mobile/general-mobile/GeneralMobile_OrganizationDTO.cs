...
{
    public class GeneralMobile_OrganizationDTO : DataDTO
    {
        ...
        public GeneralMobile_OrganizationDTO() { }
        public GeneralMobile_OrganizationDTO(Organization Organization)
        {
    ...
    public class GeneralMobile_OrganizationFilterDTO : FilterDTO
    {
