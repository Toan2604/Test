...
{
    public class GeneralMobile_ProductGroupingDTO : DataDTO
    {
        ...
        public GeneralMobile_ProductGroupingDTO() { }
        public GeneralMobile_ProductGroupingDTO(ProductGrouping ProductGrouping)
        {
    ...
    public class GeneralMobile_ProductGroupingFilterDTO : FilterDTO
    {
