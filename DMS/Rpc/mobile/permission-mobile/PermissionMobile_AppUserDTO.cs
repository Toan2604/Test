...
{
    public class PermissionMobile_AppUserDTO : DataDTO
    {
        ...
        public PermissionMobile_AppUserDTO() { }
        public PermissionMobile_AppUserDTO(AppUser AppUser)
        {
    ...
    public class PermissionMobile_AppUserFilterDTO : FilterDTO
    {
