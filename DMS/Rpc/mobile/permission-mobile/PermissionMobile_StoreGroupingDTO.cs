...
{
    public class PermissionMobile_StoreGroupingDTO : DataDTO
    {
        ...
        public PermissionMobile_StoreGroupingDTO() { }
        public PermissionMobile_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class PermissionMobile_StoreGroupingFilterDTO : FilterDTO
    {
