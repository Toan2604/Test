...
{
    public class PermissionMobile_StoreDTO : DataDTO
    {
        ...
        public PermissionMobile_DistrictDTO District { get; set; }
        public PermissionMobile_OrganizationDTO Organization { get; set; }
        public PermissionMobile_StoreDTO ParentStore { get; set; }
        public PermissionMobile_ProvinceDTO Province { get; set; }
        public PermissionMobile_StoreTypeDTO StoreType { get; set; }
        public PermissionMobile_WardDTO Ward { get; set; }
        public PermissionMobile_AppUserDTO Creator { get; set; }
        public PermissionMobile_StoreDTO() { }
        public PermissionMobile_StoreDTO(Store Store)
        {
            this.Id = Store.Id;
            ...
            this.Creator = Store.Creator == null ? null : new PermissionMobile_AppUserDTO(Store.Creator);
            this.District = Store.District == null ? null : new PermissionMobile_DistrictDTO(Store.District);
            this.Organization = Store.Organization == null ? null : new PermissionMobile_OrganizationDTO(Store.Organization);
            this.ParentStore = Store.ParentStore == null ? null : new PermissionMobile_StoreDTO(Store.ParentStore);
            this.Province = Store.Province == null ? null : new PermissionMobile_ProvinceDTO(Store.Province);
            this.StoreType = Store.StoreType == null ? null : new PermissionMobile_StoreTypeDTO(Store.StoreType);
            this.Ward = Store.Ward == null ? null : new PermissionMobile_WardDTO(Store.Ward);
            this.Errors = Store.Errors;
            this.Warnings = Store.Warnings;
        }
    }

    public class PermissionMobile_StoreFilterDTO : FilterDTO
    {
