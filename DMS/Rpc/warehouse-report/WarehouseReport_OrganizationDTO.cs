...
{
    public class WarehouseReport_OrganizationDTO : DataDTO
    {
        ...
        public WarehouseReport_OrganizationDTO() { }
        public WarehouseReport_OrganizationDTO(Organization Organization)
        {
    ...
    public class WarehouseReport_OrganizationFilterDTO : FilterDTO
    {
