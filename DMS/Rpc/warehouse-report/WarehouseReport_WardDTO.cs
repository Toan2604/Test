...
{
    public class WarehouseReport_WardDTO : DataDTO
    {
        ...
        public WarehouseReport_WardDTO() { }
        public WarehouseReport_WardDTO(Ward Ward)
        {
    ...
    public class WarehouseReport_WardFilterDTO : FilterDTO
    {
