...
{
    public class WarehouseReport_ProductDTO : DataDTO
    {
        ...
        public List<WarehouseReport_ProductProductGroupingMappingDTO> ProductProductGroupingMappings { get; set; }
        public WarehouseReport_UnitOfMeasureDTO UnitOfMeasure { get; set; }

        public WarehouseReport_ProductDTO() { }
        public WarehouseReport_ProductDTO(Product Product)
        {
            ...
            this.ProductProductGroupingMappings = Product.ProductProductGroupingMappings?.Select(p => new WarehouseReport_ProductProductGroupingMappingDTO(p)).ToList();
            this.UnitOfMeasure = Product.UnitOfMeasure == null ? null : new WarehouseReport_UnitOfMeasureDTO(Product.UnitOfMeasure);

            this.Errors = Product.Errors;
        }
    }

    public class WarehouseReport_ProductFilterDTO : FilterDTO
    {
