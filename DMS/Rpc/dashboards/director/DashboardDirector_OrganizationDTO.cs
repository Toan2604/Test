...
{
    public class DashboardDirector_OrganizationDTO : DataDTO
    {
        ...
        public DashboardDirector_OrganizationDTO() { }
        public DashboardDirector_OrganizationDTO(Organization Organization)
        {
    ...
    public class DashboardDirector_OrganizationFilterDTO : FilterDTO
    {
