...
{
    public class DashboardMonitor_OrganizationDTO : DataDTO
    {
        ...
        public DashboardMonitor_OrganizationDTO() { }
        public DashboardMonitor_OrganizationDTO(Organization Organization)
        {
    ...
    public class DashboardMonitor_OrganizationFilterDTO : FilterDTO
    {
