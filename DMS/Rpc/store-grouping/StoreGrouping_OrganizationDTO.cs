...
{
    public class StoreGrouping_OrganizationDTO : DataDTO
    {
        ...
        public StoreGrouping_OrganizationDTO(Organization Organization)
        {
    ...
    public class StoreGrouping_OrganizationFilterDTO : FilterDTO
    {
