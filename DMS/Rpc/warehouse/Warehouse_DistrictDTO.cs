...
{
    public class Warehouse_DistrictDTO : DataDTO
    {
        ...
        public Warehouse_DistrictDTO() { }
        public Warehouse_DistrictDTO(District District)
        {
    ...
    public class Warehouse_DistrictFilterDTO : FilterDTO
    {
