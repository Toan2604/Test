...
{
    public class AppUser_StoreGroupingDTO : DataDTO
    {
        ...
        public AppUser_StoreGroupingDTO() { }
        public AppUser_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class AppUser_StoreGroupingFilterDTO : FilterDTO
    {
