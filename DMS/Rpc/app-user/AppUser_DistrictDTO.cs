...
{
    public class AppUser_DistrictDTO : DataDTO
    {
        ...
        public AppUser_DistrictDTO() { }
        public AppUser_DistrictDTO(District District)
        {
    ...
    public class AppUser_DistrictFilterDTO : FilterDTO
    {
