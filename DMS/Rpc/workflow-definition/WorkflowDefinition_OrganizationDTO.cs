...
{
    public class WorkflowDefinition_OrganizationDTO : DataDTO
    {
        ...
        public WorkflowDefinition_OrganizationDTO() { }
        public WorkflowDefinition_OrganizationDTO(Organization Organization)
        {
    ...
    public class WorkflowDefinition_OrganizationFilterDTO : FilterDTO
    {
