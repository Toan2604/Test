...
namespace DMS.Repositories
{
    ...
    public class CommentRepository : ICommentRepository
    {
        ...
        {
            int count = await DataContext.Comment.Where(p => p.DiscussionId == DiscussionId).CountWithNoLockAsync();
            return count;
        }
        ...
        {
            CommentDAO CommentDAO = await DataContext.Comment.Where(p => p.Id == Comment.Id).FirstOrDefaultWithNoLockAsync();
