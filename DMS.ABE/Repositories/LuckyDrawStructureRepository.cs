...
namespace DMS.ABE.Repositories
{
    ...
    public class LuckyDrawStructureRepository : ILuckyDrawStructureRepository
    {
        ...
        {
            List<LuckyDrawStructure> LuckyDrawStructures = await query.Select(q => new LuckyDrawStructure()
            {
        ...
        public async Task<int> CountAll(LuckyDrawStructureFilter filter)
        {
            ...
            return await LuckyDrawStructureDAOs.CountAsync();
        }
        ...
        public async Task<List<LuckyDrawStructure>> List(List<long> Ids)
        {
            ...
            List<LuckyDrawStructure> LuckyDrawStructures = await query.AsNoTracking()
        ...
        {
            LuckyDrawStructure LuckyDrawStructure = await DataContext.LuckyDrawStructure.AsNoTracking()
            .Where(x => x.Id == Id)
            .Select(x => new LuckyDrawStructure()
            {
                Id = x.Id,
        ...
        public async Task<bool> BulkMerge(List<LuckyDrawStructure> LuckyDrawStructures)
        {
            ...
            List<LuckyDrawStructureDAO> DbLuckyDrawStructureDAOs = await DataContext.LuckyDrawStructure
            ...
            await DataContext.BulkMergeAsync(LuckyDrawStructureDAOs);
            return true;
        }
