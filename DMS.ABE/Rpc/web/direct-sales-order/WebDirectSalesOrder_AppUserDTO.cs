...
{
    public class WebDirectSalesOrder_AppUserDTO : DataDTO
    {
        ...
        public WebDirectSalesOrder_AppUserDTO() { }
        public WebDirectSalesOrder_AppUserDTO(AppUser AppUser)
        {
            this.Id = AppUser.Id;
    ...
    public class WebDirectSalesOrder_AppUserFilterDTO : FilterDTO
    {
