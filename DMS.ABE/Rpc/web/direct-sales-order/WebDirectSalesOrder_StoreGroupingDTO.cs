...
{
    public class WebDirectSalesOrder_StoreGroupingDTO : DataDTO
    {
        ...
        public WebDirectSalesOrder_StoreGroupingDTO() { }
        public WebDirectSalesOrder_StoreGroupingDTO(StoreGrouping StoreGrouping)
        {
    ...
    public class WebDirectSalesOrder_StoreGroupingFilterDTO : FilterDTO
    {
