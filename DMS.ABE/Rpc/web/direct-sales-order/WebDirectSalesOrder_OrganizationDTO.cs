...
{
    public class WebDirectSalesOrder_OrganizationDTO : DataDTO
    {
        ...
        public WebDirectSalesOrder_OrganizationDTO() { }
        public WebDirectSalesOrder_OrganizationDTO(Organization Organization)
        {
    ...
    public class WebDirectSalesOrder_OrganizationFilterDTO : FilterDTO
    {
