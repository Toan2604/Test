...
{
    public class WebLuckyDraw_StoreDTO : DataDTO
    {
        ...
        public WebLuckyDraw_StoreDTO() {}
        public WebLuckyDraw_StoreDTO(Store Store)
        {
    ...
    public class WebLuckyDraw_StoreFilterDTO : FilterDTO
    {
