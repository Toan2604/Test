...
{
    public class WebLuckyDraw_LuckyDrawRegistrationDTO : DataDTO
    {
        ...
        public WebLuckyDraw_AppUserDTO AppUser { get; set; }
        public WebLuckyDraw_LuckyDrawDTO LuckyDraw { get; set; }
        public WebLuckyDraw_StoreDTO Store { get; set; }
        public WebLuckyDraw_LuckyDrawRegistrationDTO() {}
        public WebLuckyDraw_LuckyDrawRegistrationDTO(LuckyDrawRegistration LuckyDrawRegistration)
        {
            ...
            this.AppUser = LuckyDrawRegistration.AppUser == null ? null : new WebLuckyDraw_AppUserDTO(LuckyDrawRegistration.AppUser);
            this.LuckyDraw = LuckyDrawRegistration.LuckyDraw == null ? null : new WebLuckyDraw_LuckyDrawDTO(LuckyDrawRegistration.LuckyDraw);
            this.Store = LuckyDrawRegistration.Store == null ? null : new WebLuckyDraw_StoreDTO(LuckyDrawRegistration.Store);
    ...
    public class WebLuckyDraw_LuckyDrawRegistrationFilterDTO : FilterDTO
    {
