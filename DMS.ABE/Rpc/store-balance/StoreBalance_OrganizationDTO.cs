...
{
    public class StoreBalance_OrganizationDTO : DataDTO
    {
        ...
        public StoreBalance_OrganizationDTO() { }
        public StoreBalance_OrganizationDTO(Organization Organization)
        {
    ...
    public class StoreBalance_OrganizationFilternDTO : FilterDTO
    {
