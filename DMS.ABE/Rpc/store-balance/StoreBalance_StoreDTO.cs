...
using System.Linq;
using DMS.Rpc.ABE.direct_sales_order;

namespace DMS.ABE.Rpc.store_balance
{
    public class StoreBalance_StoreDTO : DataDTO
    {
        ...
        public StoreBalance_StoreDTO() { }
        public StoreBalance_StoreDTO(Store Store)
        {
    ...
    public class StoreBalance_StoreFilterDTO : FilterDTO
    {
