...
{
    public class DirectSalesOrder_PrintDirectOrderContentDTO : DataDTO
    {
        ...
        public DirectSalesOrder_PrintDirectOrderContentDTO() { }
        public DirectSalesOrder_PrintDirectOrderContentDTO(DirectSalesOrderContent DirectSalesOrderContent)
        {
