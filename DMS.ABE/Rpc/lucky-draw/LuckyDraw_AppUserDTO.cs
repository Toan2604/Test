...
{
    public class LuckyDraw_AppUserDTO : DataDTO
    {
        ...
        public LuckyDraw_AppUserDTO() {}
        public LuckyDraw_AppUserDTO(AppUser AppUser)
        {
    ...
    public class LuckyDraw_AppUserFilterDTO : FilterDTO
    {
